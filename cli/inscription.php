<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql1 = "INSERT INTO personnes (nom_pers, prenoms_pers, telephone_pers,
                email_pers, commune_pers, mdp_pers) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt1 = $conn->prepare($sql1);
        $stmt1->bind_param("ssssss", $nom, $prenoms, $telephone, $email, $commune, $mdp_hash);
        ...
        if ($stmt1->execute()) {
            ...
            // ID du rôle à insérer dans la table `rolepersonnes`
            $role_id = 3;
            ...
            if ($stmt2->execute()) {
                ...
                // Démarrer une session et rediriger vers une autre page
                $_SESSION['user'] = $user;
